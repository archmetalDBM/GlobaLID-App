...
data.frame(
  Portrait = paste0('![](../www/SdMadinabeitia.png){height=96px}'), 
  Text = paste("<b>Sonia García de Madinabeitia</b> (Iberian Peninsula)", 
               "Department of Anthropology, University of Oklahoma, Norman, OK, USA", 
               paste(
                 add_Link("mailto:sonia.gdm@ehu.eus?subject=GlobaLID", "envelope", "fa"),
                 add_Link("https://www.ehu.eus/bilatu/buscar/seekuser.php?lang=es&u=bnBiZ2FtYXM=", "globe", "fa"),
                 add_Link("https://orcid.org/0000-0002-3648-6490", "orcid", "ai"),
                 add_Link("https://www.researchgate.net/profile/Sonia-Garcia-De-Madinabeitia", "researchgate", "ai"),
                 sep = " "), 
               sep = "<br>")
) %>% 
  kable(escape = FALSE, col.names = NULL, format = "html") %>% 
...
data.frame(
  ...
  Text = paste("<b>Grzegorz Żabiński</b> (Glass)", 
               "FNRS researcher CReA-patrimoine and 4MAT, Université Libre de Bruxelles, Belgium", 
               paste(
...
data.frame(
  Logo = paste0('<a href="https://www.bergbaumuseum.de/en/" target="_blank"><img alt="DBM Logo" src="../www/Logo_DBM.png"
         width="96"></a>'), 
...
data.frame(
  Logo = paste0('<a href="https://www.dmt-lb.de/" target="_blank"><img alt="DMT Logo" src="../www/Logo_DMT.svg"
         width="96"></a>'), 
  Text = paste("Web Hosting: ", 
...
data.frame(
  Logo = paste0('<a href="https://www.dfg.de/en" target="_blank"><img alt="DFG Logo" src="../www/dfg_logo.gif"
         width="150"></a>'), 
