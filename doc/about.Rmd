...
data.frame(
  ...
  Text = paste("<b>Thomas Rose</b> (Programming)", 
               "Goethe-Universität Frankfurt, Institut für Geowissenschaften, Frankfurt, Germany  <br> Department of Archaeology, Ben-Gurion University of the Negev, Be’er Sheva, Israel <br> Department of Antiquity, Sapienza University of Rome, Rome, Italy <br> Forschungsbereich Archäometallurgie, Leibniz-Forschungsmuseum für Georessourcen/Deutsches Bergbau-Museum Bochum, Bochum, Germany", 
               paste(
...
data.frame(
  ...
  Text = paste("<b>María Florencia Becerra</b> (South America)", 
               "Facultad de Filosofía y Letras, Universidad de Buenos Aires, Instituto de Arqueología, CONICET, Buenos Aires, Argentina <br> Forschungsbereich Archäometallurgie, Leibniz-Forschungsmuseum für Georessourcen/Deutsches Bergbau-Museum Bochum, Bochum, Germany", 
               paste(
...
data.frame(
  Portrait = paste0('![](../www/MVaxevanopoulos.png){height=96px}'), 
  Text = paste("<b>Markos Vaxevanopoulos</b>", 
               "École Normale Supérieure de Lyon, Laboratoire de Géologie de Lyon: Terre, Planète, Environnement, Lyon, France",  
               paste(
                 add_Link("https://orcid.org/0000-0003-3027-5622", "orcid", "ai"),
                 add_Link("https://auth.academia.edu/MarkosVaxevanopoulos", "academia", "ai"),
                 add_Link("https://www.researchgate.net/profile/Markos-Vaxevanopoulos", "researchgate", "ai"),
                 sep = " "), 
               sep = "<br>")
) %>%
kable(escape = FALSE, col.names = NULL) %>% 
