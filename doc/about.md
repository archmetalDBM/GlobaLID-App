...
© The GlobaLID Core Team 2026 (unless indicated otherwise)
...
bibtex
    ...
    @misc{GlobaLIDCoreTeam.2025,
     ...
     year = {2025},
     title = {{GlobaLID web application V. 1.1, database status: 2026-07-03}},
...
ris
    ...
    ET  - V. 1.1, database status: 2026-07-03
    PY  - 2025
    DA  - 2025
