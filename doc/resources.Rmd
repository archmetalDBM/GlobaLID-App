...
The web application is written in [R](https://cran.r-project.org/). The following functions were specifically developed for GlobaLID. To use them in your own work, download them by clicking on the function name and load them into R with `source()`. 
