...
table <- data.frame(
  ...
  date = c("2021-06-20", "2021-07-24", "2021-06-04", "2021-09-23")
)
...
The source code of the GlobaLID web application is available on [GitHub](https://github.com/archmetalDBM/GlobaLID-App). 
