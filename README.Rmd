...
* GlobaLID Core Team. (2025). GlobaLID web application V. `r app_version`, database status: `r format.Date(update_database, "%F")`. [https://globalid.dmt-lb.de/](https://globalid.dmt-lb.de/)
